				...
				<Block>
					...
					<div className={s.contactsContent}>
						<div className={s.contactsAdress}>
							<h3>Наш адрес</h3>
							<p>
								450074 г. Уфа, бульвар Н. Наджми, д. 19, офис 2А
								info@predelufa.ru
							</p>
						...
						<div className={s.contactsDetails}>
							...
							<p>
								Юр. адрес: 450074 г.Уфа, бульвар Назара Наджми, д. 19 офис 2А
								ИНН 0278921967 КПП 027401001 ОГРН 1160280112849
							</p>
							<p>
								БАШКИРСКОЕ ОТДЕЛЕНИЕ N8598 ПАО СБЕРБАНК Кор. сч.
								30101810300000000601 БИК 048073601 Расч. сч.
								40702810106000020026
							</p>
